...
/**
 * 3D isometric server loader (from uiverse.io/Juanes200122/fresh-yak-92, MIT).
 * Renders a pulsing isometric server with floating particles.
 */
export function UiverseServerLoader({ className }: { className?: string }) {
  return (
    <div className={className}>
      <style>{`
        ...
        @keyframes uiverse-fade-particles {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.5; }
        }
        @keyframes uiverse-float-up {
          0% { transform: translateY(0); opacity: 0; }
          10% { opacity: 1; }
          100% { transform: translateY(-40px); opacity: 0; }
        }
        .uiverse-particles { animation: uiverse-fade-particles 5s infinite alternate; }
        .uiverse-particle { animation: uiverse-float-up linear infinite; }
        .uiverse-p1 { animation-duration: 2.2s; animation-delay: 0s; }
        .uiverse-p2 { animation-duration: 2.5s; animation-delay: 0.3s; }
        .uiverse-p3 { animation-duration: 2s; animation-delay: 0.6s; }
        .uiverse-p4 { animation-duration: 2.8s; animation-delay: 0.2s; }
        .uiverse-p5 { animation-duration: 2.3s; animation-delay: 0.4s; }
        .uiverse-p6 { animation-duration: 3s; animation-delay: 0.1s; }
        .uiverse-p7 { animation-duration: 2.1s; animation-delay: 0.5s; }
        .uiverse-p8 { animation-duration: 2.6s; animation-delay: 0.2s; }
        .uiverse-p9 { animation-duration: 2.4s; animation-delay: 0.3s; }
        @keyframes uiverse-bounce-lines {
          0%, 100% { transform: translateY(0); }
          50% { transform: translateY(-3px); }
        }
        .uiverse-line-v1, .uiverse-line-v2, .uiverse-node-server,
        .uiverse-panel-right, .uiverse-reflectores, .uiverse-particles {
          animation: uiverse-bounce-lines 3s ease-in-out infinite alternate;
        }
        .uiverse-line-v2 { animation-delay: 0.2s; }
        .uiverse-node-server, .uiverse-panel-right, .uiverse-reflectores, .uiverse-particles {
          animation-delay: 0.4s;
        }
      `}</style>

      <svg
        className="uiverse-svg-global"
      ...
      >
        ...
        <path
          ...
          className="uiverse-line-v2"
        />
        <g className="uiverse-node-server">
          <path
            fill="url(#uiverse-paint0_204_217)"
          ...
          />
          <path
            stroke="url(#uiverse-paint2_204_217)"
            fill="url(#uiverse-paint1_204_217)"
          ...
          <g mask="url(#uiverse-mask0_204_217)">
            <path
              fill="#332C94"
              d="M78.3486 68.7324L49.0242 51.0584C47.6459 50.2276 45.4111 50.2276 44.0328 51.0584L14.7084 68.7324C13.3301 69.5631 13.3301 70.91 14.7084 71.7407L44.0328 89.4148C45.4111 90.2455 47.6459 90.2455 49.0242 89.4148L78.3486 71.7407C79.7269 70.91 79.727 69.5631 78.3486 68.7324Z"
            />
            ...
            <g mask="url(#uiverse-mask1_204_217)">
              <path
                fill="#5E5E5E"
                d="M68.9898 68.7324L49.0242 56.699C47.6459 55.8683 45.4111 55.8683 44.0328 56.699L24.0673 68.7324C22.6889 69.5631 22.6889 70.91 24.0673 71.7407L44.0328 83.7741C45.4111 84.6048 47.6459 84.6048 49.0242 83.7741L68.9898 71.7407C70.3681 70.91 70.3681 69.5631 68.9898 68.7324Z"
              />
        ...
        <g className="uiverse-particles">
          <path
            fill="url(#uiverse-paint3_204_217)"
            ...
            className="uiverse-particle uiverse-p1"
          />
          <path
            fill="url(#uiverse-paint4_204_217)"
            ...
            className="uiverse-particle uiverse-p2"
          />
          <path
            fill="url(#uiverse-paint5_204_217)"
            ...
            className="uiverse-particle uiverse-p3"
          />
          <path
            fill="url(#uiverse-paint6_204_217)"
            ...
            className="uiverse-particle uiverse-p4"
          />
          <path
            fill="url(#uiverse-paint7_204_217)"
            ...
            className="uiverse-particle uiverse-p5"
          />
          <path
            fill="url(#uiverse-paint8_204_217)"
            ...
            className="uiverse-particle uiverse-p6"
          />
          <path
            fill="url(#uiverse-paint9_204_217)"
            ...
            className="uiverse-particle uiverse-p7"
          />
          <path
            fill="url(#uiverse-paint10_204_217)"
            ...
            className="uiverse-particle uiverse-p8"
          />
          <path
            fill="url(#uiverse-paint11_204_217)"
            ...
            className="uiverse-particle uiverse-p9"
          />
        </g>
        <g className="uiverse-reflectores">
          <path
            fillOpacity="0.2"
            fill="url(#uiverse-paint12_204_217)"
          ...
          <path
            fillOpacity="0.2"
            fill="url(#uiverse-paint13_204_217)"
        ...
        <g className="uiverse-panel-right">
          <mask fill="white" id="uiverse-path-26-inside-1_204_217">
          ...
          />
          <path
            mask="url(#uiverse-path-26-inside-1_204_217)"
            fill="#489CB7"
          ...
          />
          <mask fill="white" id="uiverse-path-28-inside-2_204_217">
          ...
          />
          <path
            mask="url(#uiverse-path-28-inside-2_204_217)"
            fill="#489CB7"
