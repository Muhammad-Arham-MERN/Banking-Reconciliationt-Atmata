...
# shadcn
- Prefer using official shadcn UI components over custom hand-rolled implementations — explicitly requested the dark mode toggle "using shadcn ui (search docs)" rather than a hand-rolled theme switch; in the 15-feature UX spec he again referenced shadcn's docs for each new UI primitive (collapsible, drawer, popover — "You can view https://ui.shadcn.com/docs/components/base/collapsible for help") and expects them built from those components. Confidence: 0.8
...
# backend-api
See [backend-api/taste.md](backend-api/taste.md)
